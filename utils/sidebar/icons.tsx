export const Icons = {
  ...
  // BookOpen - for Subjects & Marks (universal symbol for study/courses)
  ...
  // CalendarClock - for Timetable (schedule representation)
  ...
  // Library - for Books List (collection of books on a shelf)
