...
export const mockReportCards: Record<string, ReportCardData> = {
  "class-5": {
    ...
    termSummaries: [
      { term: "Term 1", totalObtained: 690, totalMaxMarks: 800, percentage: 86.25, grade: "A" },
      { term: "Term 2", totalObtained: 712, totalMaxMarks: 800, percentage: 89.0, grade: "A" },
    ],
    ...
    finalGrade: "A",
    rank: "3rd",
    remarks: "Ali shows excellent performance in Class 5. He has a strong foundation in Mathematics and Computer Science. His improvement in Science from Term 1 to Term 2 is commendable. Keep up the good work!",
  ...
  "class-6": {
    ...
    termSummaries: [
      { term: "Term 1", totalObtained: 710, totalMaxMarks: 800, percentage: 88.75, grade: "A" },
      { term: "Term 2", totalObtained: 728, totalMaxMarks: 800, percentage: 91.0, grade: "A+" },
    ],
    ...
    finalGrade: "A",
    rank: "2nd",
    remarks: "Ali continues to excel in Class 6. His performance in Mathematics and Islamiat is outstanding. He shows consistent improvement across all subjects. Keep up the excellent work!",
  ...
  "class-7": {
    ...
    termSummaries: [
      { term: "Term 1", totalObtained: 640, totalMaxMarks: 800, percentage: 80.0, grade: "A" },
      { term: "Term 2", totalObtained: 665, totalMaxMarks: 800, percentage: 83.1, grade: "A" },
    ],
    ...
    finalGrade: "A",
    rank: "8th",
    remarks: "Ali shows good improvement from Term 1 to Term 2. He excels in Computer Science and Physical Education. Needs to focus more on English and Social Studies. Regular revision will help improve his performance.",
  ...
  "class-8": {
    ...
    termSummaries: [
      { term: "Term 1", totalObtained: 728, totalMaxMarks: 800, percentage: 91.0, grade: "A+" },
      { term: "Term 2", totalObtained: 746, totalMaxMarks: 800, percentage: 93.25, grade: "A+" },
    ],
    ...
    finalGrade: "A+",
    rank: "1st",
    remarks: "Ali is an exceptional student with outstanding academic performance. He consistently ranks first in class and shows remarkable aptitude in Mathematics and Computer Science. His disciplined approach and curiosity make him an ideal student. Highly recommended for advanced studies.",
