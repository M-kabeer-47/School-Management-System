import { ExamDocument, TermResult } from "@/lib/types/exams";
...
export const examDocuments: ExamDocument[] = [
    {
        ...
        type: "exam-slip",
        pdfUrl: "https://mahesararslan-merge-bucket.s3.eu-north-1.amazonaws.com/room-files/77f26d1c-26cb-418c-b98c-3c7391dcef8b/1765735147127-e3bb11be-f6af-48e8-870a-688d243d34f3.pdf",
...
export const previousResults: TermResult[] = [
    {
        ...
        subjects: [
            ...
            { subject: "Mathematics", totalMarks: 100, obtainedMarks: 92, grade: "A+" },
    ...
    },
    {
        ...
        subjects: [
            ...
            { subject: "Mathematics", totalMarks: 100, obtainedMarks: 88, grade: "A" },
    ...
    },
    {
        ...
        subjects: [
            ...
            { subject: "Mathematics", totalMarks: 100, obtainedMarks: 95, grade: "A+" },
            { subject: "Science", totalMarks: 100, obtainedMarks: 88, grade: "A" },
