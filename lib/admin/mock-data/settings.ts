...
export const feeHeads: FeeHead[] = [
  ...
  },
  {
    ...
    amount: 400,
    frequency: "monthly",
    applicableTo: "all", // "all" within this wing/scope
    isActive: true,
    wingId: "group-2",
  },
  {
  ...
  // GLOBAL FEES (Applicable to all if no wing specified, or legacy)
  {
    id: "fee-glob-1",
    name: "Sports Fee",
    amount: 1000,
