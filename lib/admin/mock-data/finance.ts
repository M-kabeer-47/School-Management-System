...
export const feeDiscounts: FeeDiscount[] = [
    { id: "d1", name: "Sibling Discount", type: "percentage", value: 10, description: "10% off for siblings" },
    { id: "d2", name: "Staff Child", type: "percentage", value: 50, description: "50% off for staff children" },
    { id: "d3", name: "Merit Scholarship", type: "percentage", value: 25, description: "25% for merit students" },
    { id: "d4", name: "Need-based", type: "percentage", value: 30, description: "30% for financially weak" },
    { id: "d5", name: "Early Payment", type: "fixed", value: 200, description: "Rs. 200 off for early payment" },
];
...
export const expenses: Expense[] = [
    { id: "exp-001", date: "2026-01-15", category: "Utilities", description: "Electricity bill for December", amount: 45000, paymentMethod: "bank", vendor: "K-Electric", receiptNo: "KE-DEC-2025", addedBy: "Admin Office" },
    { id: "exp-002", date: "2026-01-12", category: "Maintenance", description: "Plumbing repair - washrooms", amount: 8500, paymentMethod: "cash", vendor: "Ali Plumber", addedBy: "Maintenance Dept" },
    { id: "exp-003", date: "2026-01-10", category: "Stationery", description: "Office supplies and paper", amount: 12000, paymentMethod: "cash", vendor: "ABC Stationery", receiptNo: "ABC-1234", addedBy: "Admin Office" },
    { id: "exp-004", date: "2026-01-08", category: "Transport", description: "Bus fuel and maintenance", amount: 35000, paymentMethod: "bank", vendor: "PSO Fuel Station", addedBy: "Transport Dept" },
];

// Summary Statistics
export const getFinanceStats = () => {
    const totalCollected = recentPayments.reduce((sum, p) => sum + p.amount, 0);
    const totalPending = feeChallans.filter(c => c.status === "pending" || c.status === "overdue").reduce((sum, c) => sum + c.netAmount, 0);
