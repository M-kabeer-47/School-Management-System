...
export const SidebarFooter = ({ user, isCollapsed }: SidebarFooterProps) => {
  return (
    <div className="p-4 border-t border-border mt-auto">
      ...
      >
        <div className="flex items-center gap-3 overflow-hidden">
          <div className="w-10 h-10 rounded-full bg-accent-light flex items-center justify-center flex-shrink-0 text-accent font-bold">
            {user.avatarUrl ? (
              <img
                src={user.avatarUrl}
                alt={user.name}
