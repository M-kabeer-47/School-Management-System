              ...
              <table className="w-full">
                <tbody>
                  <tr>
                    ...
                    <td className="py-1 font-semibold border-b border-gray-400 border-dotted">
                      {data.studentName}
                    </td>
                    <td className="py-1 text-gray-600 w-28 pl-6">
                      Class/Section:
                    </td>
                    <td className="py-1 font-semibold border-b border-gray-400 border-dotted">
                  ...
                  <tr>
                    ...
                    <td
                      className="py-1 font-semibold border-b border-gray-400 border-dotted"
                      colSpan={3}
                    >
                      {data.teacher}
                    </td>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-gray-800 text-white">
                <th
                  className="border border-gray-600 px-2 py-2 text-left font-bold"
                  rowSpan={2}
                >
                  SUBJECTS
                </th>
                {data.terms.map((term) => (
                  <th
                    key={term}
                    className="border border-gray-600 px-2 py-1.5 text-center font-bold"
                    colSpan={2}
                  >
                    {term.toUpperCase()}
                  </th>
                ...
                <th
                  className="border border-gray-600 px-2 py-1.5 text-center font-bold bg-gray-900"
                  colSpan={2}
                >
                  FINAL
                </th>
              ...
              <tr className="bg-gray-700 text-white text-xs">
                {data.terms.map((term) => (
                  <>
                    <th
                      key={`${term}-m`}
                      className="border border-gray-600 px-1 py-1 text-center w-14"
                    >
                      Marks
                    </th>
                    <th
                      key={`${term}-g`}
                      className="border border-gray-600 px-1 py-1 text-center w-10"
                    >
                      Grade
                    </th>
                  </>
                ...
                >
                  ...
                  {subject.termMarks.map((term) => (
                    <>
                      <td
                        key={`${term.term}-marks`}
                        className="border border-gray-400 px-1 py-1.5 text-center"
                      >
            ...
            <tfoot>
              ...
              <tr className="bg-gray-100">
                ...
                <td
                  className="border border-gray-400 px-1 py-1.5 text-center font-bold bg-gray-200"
                  colSpan={2}
                >
                ...
                <tbody>
                  {gradeScale.map((item, index) => (
                    <tr
                      ...
                      className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}
                    >
                      <td className="border-t border-gray-300 px-2 py-0.5 font-bold w-10">
                        {item.grade}
                      </td>
                      <td className="border-t border-l border-gray-300 px-2 py-0.5 text-center">
              ...
              <table className="w-full">
                <tbody>
                  <tr>
                    ...
                    <td className="border-t border-l border-gray-300 px-2 py-1 text-center font-semibold">
                  ...
                  <tr className="bg-gray-100 font-bold">
                    ...
                    <td className="border-t border-l border-gray-300 px-2 py-1 text-center">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border-t border-l border-gray-300 px-2 py-1 text-center font-bold text-lg">
                      {data.finalGrade}
                    </td>
                  </tr>
                  <tr className="bg-gray-100">
