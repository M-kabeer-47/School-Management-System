        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="w-full">
                ...
                <select
                    ...
                    className={cn(
                        "flex h-11 w-full rounded-xl border-2 bg-background px-4 py-2 text-sm text-text-primary transition-all duration-200",
            ...
            <div className="w-full">
                ...
                <textarea
                    ...
                    rows={5}
                    className={cn(
                        "flex w-full rounded-xl border-2 bg-background px-4 py-3 text-sm text-text-primary transition-all duration-200 resize-none",
