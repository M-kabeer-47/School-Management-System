...
import { FileText, Calendar, ExternalLink, ClipboardList } from "lucide-react";
import { ExamDocument } from "@/lib/instructor/types/exams";
...
export const ExamDocumentCard = ({
    ...
    const isDatesheet = document.type === "datesheet";
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div
                        className={cn(
                            ...
                            isDatesheet ? "bg-accent-gradient" : "bg-info-light"
                        )}
                    >
                        {isDatesheet ? (
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        >
                            {isDatesheet ? "Date Sheet" : "Invigilation Schedule"}
                        </span>
