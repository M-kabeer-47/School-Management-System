...
// Animation variants for the sidebar wrapper (Same as student)
...
export const InstructorSidebar = ({ className }: SidebarComponentProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <InstructorSidebarHeader isCollapsed={isCollapsed} />
