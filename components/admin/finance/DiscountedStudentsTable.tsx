...
export function DiscountedStudentsTable({ students, onViewDetails }: DiscountedStudentsTableProps) {
    const getDiscountColor = (type: string) => {
        const colors: Record<string, string> = {
            "Sibling Discount": "bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800",
            "Staff Child": "bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800",
            "Merit Scholarship": "bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800",
            "Need-based": "bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-400 border-orange-200 dark:border-orange-800",
        };
        return colors[type] || "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-gray-700";
    };
