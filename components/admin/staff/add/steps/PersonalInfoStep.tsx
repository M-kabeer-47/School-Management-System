...
import { User, Calendar, Phone, Mail, MapPin, CreditCard, Upload } from "lucide-react";
import { clsx } from "clsx";
import { StaffPersonalInfoInput } from "@/components/admin/schemas/staff-schemas";
...
export default function PersonalInfoStep() {
    const {
        ...
        watch,
        formState: { errors },
    } = useFormContext<StaffPersonalInfoInput>();
