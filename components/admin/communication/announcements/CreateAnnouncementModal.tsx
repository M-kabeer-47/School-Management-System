...
export function CreateAnnouncementModal({
    ...
    const hasDeliveryOptions = formData.sendSms || formData.sendEmail;
                    ...
                    {saveSuccess ? (
                        ...
                        >
                            ...
                            <h3 className="text-lg font-semibold text-text-primary">
                                {isEditing ? "Announcement Updated!" : "Announcement Published!"}
                            </h3>
                            {hasDeliveryOptions && (
                            ...
                            <div>
                                ...
                                {formData.attachment ? (
                                    <div className="flex items-center gap-3 p-3 bg-surface rounded-xl border border-border">
                                        {(() => {
                                            const AttIcon = getAttachmentIcon(formData.attachment.type);
                                            return (
                                ...
                                <div className="bg-surface rounded-xl p-4 space-y-3">
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateField("sendSms", e.target.checked)
                                            }
                                            className="w-4 h-4 rounded border-border text-accent focus:ring-accent"
                                        />
                                    ...
                                    <label className="flex items-center gap-3 cursor-pointer">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateField("sendEmail", e.target.checked)
                                            }
                                            className="w-4 h-4 rounded border-border text-accent focus:ring-accent"
                                        />
