...
export const AdminSidebarHeader = ({ isCollapsed }: SidebarHeaderProps) => {
  return (
      ...
      <div className="flex items-center gap-3 text-accent transition-all duration-300">
        ...
        {!isCollapsed && (
          <div className="overflow-hidden whitespace-nowrap">
            ...
            <p className="text-[10px] text-accent font-bold tracking-widest uppercase bg-accent/10 px-1 rounded-sm w-fit mt-0.5">
              ADMIN PORTAL
            </p>
          </div>
        )}
