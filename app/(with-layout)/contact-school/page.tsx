...
import { ComplaintCard } from "@/components/contact/ComplaintCard";
import { schoolContact, mockComplaints } from "@/lib/mockData/contact";
                    ...
                    >
                        ...
                        <div className="flex border-b border-border">
                            ...
                            >
                                ...
                                Previous ({mockComplaints.length})
                            </button>
                        </div>
                            ...
                            {activeTab === "new" ? (
                                <div>
                                    <p className="text-sm text-text-secondary mb-5">
                                        Have a concern or feedback? Fill out the form below and we will
