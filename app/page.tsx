...
import { User, SidebarItem } from "@/lib/types/sidebar";
...
const menuItems: SidebarItem[] = [
  ...
  { label: "Subjects & Marks", href: "/subjects", icon: Icons.BookOpen },
  { label: "Report Cards", href: "/reports", icon: Icons.GraduationCap },
  { label: "Fee & Payments", href: "/fees", icon: Icons.Wallet },
  ...
  return (
    <div className="flex min-h-screen bg-surface">
      ...
      <main className="flex-1 min-w-0 overflow-auto">
        ...
        <header className="md:hidden h-16 bg-background border-b border-border flex items-center px-4 justify-end sticky top-0 z-30">
