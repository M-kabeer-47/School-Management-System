...
export default function AllExpensesPage() {
    ...
    const filteredExpenses = useMemo(() => {
        return expenses.filter((expense) => {
            const searchMatch =
                ...
                (expense.vendor?.toLowerCase().includes(filters.search.toLowerCase()) ?? false) ||
                (expense.receiptNo?.toLowerCase().includes(filters.search.toLowerCase()) ?? false);
            ...
            return searchMatch && categoryMatch && statusMatch && paymentMatch;
        });
    }, [filters]);
    ...
    const handleFilterChange = (key: keyof ExpenseFiltersState, value: string) => {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-background rounded-2xl border border-border p-5 shadow-sm">
                    <p className="text-sm text-text-muted font-medium">Pending Approval</p>
