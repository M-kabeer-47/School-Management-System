    ...
    return (
        ...
        >
                    ...
                    {selectedIds.length > 0 && (
                        <>
                            ...
                            <div>
                                ...
                                <p className="text-3xl font-bold text-red-700">{selectedIds.length}</p>
                            </div>
                        </>
                    )}
                </div>
                    ...
                    >
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <span className="text-sm font-medium text-red-700">
                                ...
                                {selectedDefaulters.reduce((sum, d) => sum + d.totalDue, 0).toLocaleString()}
                            </span>
            ...
            <Modal
                ...
                title={
                    sendSuccess ? "Reminders Sent!" : `Send ${reminderType.toUpperCase()} Reminder`
                }
                description={
                    sendSuccess
            ...
            >
                {sendSuccess ? (
                    <div className="text-center py-6">
                        ...
                        <p className="text-text-secondary">
                            {reminderType === "sms" ? "SMS" : "Email"} reminders have been sent to all
                            selected parents.
                        </p>
                        <Button
                            className="mt-6"
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div className="bg-surface rounded-xl p-3 max-h-32 overflow-y-auto">
                            <p className="text-xs text-text-muted mb-2 font-medium">Recipients:</p>
