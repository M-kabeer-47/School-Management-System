...
import { TeachingStaff, StaffFilters as StaffFiltersType, AnyStaff } from "@/lib/admin/types/staff";
import { teachingStaff, getUniqueDepartments } from "@/lib/admin/mock-data/staff";
...
export default function TeachingStaffPage() {
    ...
    // Drawer state
    const [selectedStaff, setSelectedStaff] = useState<TeachingStaff | null>(null);
    ...
    const departments = getUniqueDepartments("teaching");
    ...
    const handleStaffAction = (action: string, staff: AnyStaff) => {
        if (action === "view") {
            setSelectedStaff(staff as TeachingStaff);
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-text-secondary mt-1">
                        Manage teachers and academic staff
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button onClick={() => router.push("/admin/staff/teachers/add")}>
